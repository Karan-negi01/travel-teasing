          ...
          {featuredStays.map((stay) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className="absolute top-3 right-3 rounded-full bg-white/95 px-2.5 py-1 text-xs font-semibold text-gray-800 shadow-sm">
                  {stay.rating} ★
                </div>
              ...
              <div className="p-5">
                ...
                <p className="text-sm text-gray-500 mt-0.5">{stay.state}</p>
                <p className="text-sm font-semibold text-gray-700 mt-3">{stay.priceRange} / night</p>
                <button
                  type="button"
