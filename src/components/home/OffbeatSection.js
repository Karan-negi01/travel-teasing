          ...
          <div className="flex items-stretch gap-4 sm:gap-5 pb-2 snap-x snap-mandatory">
            {featuredPlaces.map((place, index) => (
              <Link
                ...
                className="snap-start w-[72vw] sm:w-[48vw] md:w-[36vw] lg:w-[260px] xl:w-[280px] flex-shrink-0 group rounded-2xl overflow-hidden border border-gray-200/80 bg-white shadow-sm hover:shadow-lg hover:border-violet-200/60 transition-all duration-300"
              >
